...
const schema = yup.object({
    ...
    github: yup.string().url("Enter a valid Github profile").matches(/github\.com/, "Enter a valid Github profile").required("Enter your Github profile"),
    linkden: yup.string().url("Enter a valid Linkden profile").matches(/linkedin\.com/, "Enter a valid Linkden profile").required("Enter your Linkden profile"),
})
