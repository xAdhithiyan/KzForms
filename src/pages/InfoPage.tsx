...
function InfoPage() {
    ...
    //if the url ends with / then the last element in the array is empty string
    if(githubParts[githubParts.length - 1] == ""){
        values.newGithub = githubParts[githubParts.length - 2]
    }else{
        values.newGithub = githubParts[githubParts.length - 1]
    }

    const linkdenParts = values.linkden.split("/")
    //if the url ends with / then the last element in the array is empty string
    if(linkdenParts[linkdenParts.length - 1] == ""){
        values.newLinkden = linkdenParts[linkdenParts.length - 2]
    }else{
            ...
            <div className="mainInfo">
                <div className="card">
                    ...
                    <div className="card-4">
                        ...
                        <div>{<a href={values.github} target="_blank">{values.newGithub}</a>}</div>
                    </div>
                ...
                <img src="src/pages/images/logo.jpg" alt="" className="info-logo-img logo-img"/>
                <div className="info-svg-img svg-img ">
